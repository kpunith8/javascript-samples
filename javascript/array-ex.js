...
console.log(
  "spliced array(1, 2, 6, 7):",
  splicedArray,
  "Original array:",
  array1
);

// The splice() method can also be used to insert values into an array at a
// specific index without removing any items, by indicating that zero items are to be removed
let spliceToInsert = array1.splice(2, 0, 8, 9); // returns [], nothing has been asked to remove
// 2: index to start, 0: number of items to remove, 8,9: items to be added
console.log(
  "splice() to insert items:",
  spliceToInsert,
  "Original array:",
  array1
);
